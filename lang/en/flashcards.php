...
$string['learnnowintro'] = 'Answer a selected number of randomly chosen questions from your personal flashcard. Use the slider or enter the value directly. <br>You can select a maximum of {$a} questions from your flashcard collection.';
...
$string['studentquestioninitinfo'] = 'Here you have, among other, the option to vote for/against ("Peer-review") specific flashcards. You can then use this information to pick the best flashcards for your learning goal.';
