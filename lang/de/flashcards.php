...
$string['authordisplay_group'] = 'Art des Erstellers (Lehrender/Studierender)';
$string['authordisplay_name'] = 'Name des Autors';
$string['authordisplay_teacherroles'] = 'Lehrendenrollen';
$string['authordisplay_teacherroles_desc'] = 'Rollen, die als Lehrender als Autor ausgewiesen werden.';
$string['author_me'] = 'Mir';
$string['author_student'] = 'Studierende/r';
$string['author_teacher'] = 'Lehrende/r';
...
$string['eventsimplequestioncreated'] = 'Teacher check wird automatisch auf korrekt gesetzt für Fragen, die von Lehrenden erstellt wurden.';
$string['eventsimplequestionupdated'] = 'Peer Review und teacher check wird auf zurückgesetzt, wenn ein Studierender inhaltliche Änderungen an der Frage vornimmt.';
...
$string['peerreview_help'] = 'Positive bzw negative Bewertungen durch Studierende nach Überprüfung der Lernkarte. (positiv/negativ)';
...
$string['privacy:metadata:flashcards:addfcstudent'] = 'Können Studierende selbstständig Lernkarten anlegen - ja (1)/ nein (0)';
$string['privacy:metadata:flashcards:studentsubcat'] = 'Studierendenfragenunterkategorie';
...
$string['privacy:metadata:flashcards_q_status:teachercheck'] = 'Lehrender bewertet die Lernkarte mit korrekt (1), inkorrekt (2) oder noch nicht bewertet (0)';
$string['privacy:metadata:flashcards_q_status'] = 'Lehrendencheckinformation für Lernkarten';
...
$string['privacy:metadata:flashcards_q_stud_rel:studentid'] = 'Studierenden User ID';
...
$string['privacy:metadata:flashcards_q_stud_rel'] = 'Detailinformationen zur Interaktion eines Studierenden mit einer Lernkarte';
...
$string['removeflashcardinfo_help'] = 'Enternt eine Lernkarte aus dieser Lernkartei. Die Lernkarte kann in der Fragenbank weiterhin bearbeitet und jederzeit wieder hinzugefügt werden.';
...
$string['studentquestioninitinfo'] = 'Sie haben hier unter anderem die Möglichkeit, unter „Peer-Review“ für Lernkarten zu voten. Nutzen Sie diese Information bei Lernkarten dafür, um diese gezielt Ihrer Lernkartei hinzuzufügen.';
...
$string['teachercheck'] = 'Lehrenden-Check';
$string['teachercheck_help'] = 'Die Karte wurde von einem Lehrenden überprüft und ist inhaltlich korrekt (✓), falsch (✗) oder wurde noch nicht evaluiert (?).';
