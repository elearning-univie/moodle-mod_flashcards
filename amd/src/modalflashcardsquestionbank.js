...
function(
    ...
    var SELECTORS = {
        ...
        ADD_QUESTIONS_FORM: 'form[action="teacherview.php"]',
    };
     ...
     */
    var ModalFlashcardsQuestionBank = function(root) {
    ...
    ModalFlashcardsQuestionBank.TYPE = 'mod_flashcards-flashcards-question-bank';
    ModalFlashcardsQuestionBank.prototype = Object.create(Modal.prototype);
    ModalFlashcardsQuestionBank.prototype.constructor = ModalFlashcardsQuestionBank;
     ...
     * @param {int} id
     */
    ModalFlashcardsQuestionBank.prototype.setContextId = function(id) {
        this.contextId = id;
    };
     ...
     * @return {int}
     */
    ModalFlashcardsQuestionBank.prototype.getContextId = function() {
     ...
     * @param {int} id
     */
    ModalFlashcardsQuestionBank.prototype.setAddOnPageId = function(id) {
        this.addOnPageId = id;
    };
     ...
     * @return {int}
     */
    ModalFlashcardsQuestionBank.prototype.getAddOnPageId = function() {
     ...
     * @return {void}
     */
    ModalFlashcardsQuestionBank.prototype.show = function() {
     ...
     */
    ModalFlashcardsQuestionBank.prototype.reloadBodyContent = function(queryString) {
     ...
     *
     * @method handleAddToFlashcardsEvent
     * @param {event} e A JavaScript event
     * @param {object} anchorElement The anchor element that was triggered
     */
    ModalFlashcardsQuestionBank.prototype.handleAddToFlashcardsEvent = function(e, anchorElement) {
     ...
     * @param {object} anchorElement The anchor element that was triggered
     */
    ModalFlashcardsQuestionBank.prototype.handlePreviewContainerEvent = function(e, anchorElement) {
        var popupOptions = [
            'height=600',
            'width=800',
            'top=0',
     ...
     * @param {event} e A JavaScript event
     */
    ModalFlashcardsQuestionBank.prototype.handleDisplayOptionFormEvent = function(e) {
     ...
     */
    ModalFlashcardsQuestionBank.prototype.registerDisplayOptionListeners = function() {
        // Listen for changes to the display options form.
     ...
     */
    ModalFlashcardsQuestionBank.prototype.registerEventListeners = function() {
        ...
        this.getModal().on('click', SELECTORS.ANCHOR, function(e) {
            ...
            if (anchorElement.closest(SELECTORS.ADD_TO_FLASHCARDS_CONTAINER).length) {
                this.handleAddToFlashcardsEvent(e, anchorElement);
                return;
            }
    ...
    return ModalFlashcardsQuestionBank;
});
